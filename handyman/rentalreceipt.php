...
$queryx = "SELECT R.Reservation_number, R.Dropoff_clerk, R.Request_customer, R.Pickup_creditcard_number, R.start_date, R.End_date, T.tool_ID, T.abbrdesc from Reservation as R inner join reserve on R.reservation_number = reserve.reservation_number inner join tool as T on T.Tool_ID = reserve.Tool_ID where R.reservation_number = '$rnumber'";
						...
						<div class="profile_section">
							...
							<table width="80%">
								...
								<tr>
									...
									<td><?php print $rowx['Dropoff_clerk']; ?></td>
