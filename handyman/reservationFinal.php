...
$Custtomer_Username = $_SESSION['email'];
$query = "INSERT INTO RESERVATION (Start_date, End_date, Request_customer) VALUES ('$startdate', '$enddate', '$Custtomer_Username')";
$result = mysql_query($query);

$reservation_number = mysql_insert_id();;
foreach ($tools as $tool){
    
    $tool = (int) $tool;
    $query = "INSERT INTO RESERVE (Reservation_number, Tool_ID) VALUES ('${reservation_number}' , '{$tool}');";
    $result = mysql_query($query);
		...
		<div id="main_container">
			...
			<div class="center_content">			
				...
				<div class="center_left">
					...
					<div class="title"><font size="5"><i>Your Reservation Number is</i></font></div>
                                        <br>
                                            <?php print $reservation_number ?>
                                        </br>
					
					<div class="Summary">   
					    <div class="title"><font size="4"><b>Tools Rented:</b></font></div>
                            ...
                            <div class="reservation">
                                                ...
                                                <div>
                                                    ...
                                                    <form name ="sample" action="reservationSum.php">
                                                        <br>
                                                        <input type="button" value = "Back To Main" style="width:200px" onClick="submitAction('customerMenu.php')"></input>
